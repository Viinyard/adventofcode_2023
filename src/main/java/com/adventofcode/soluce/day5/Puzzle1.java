...
import com.adventofcode.day5.grammar.Day5Lexer;
import com.adventofcode.day5.grammar.Day5Parser;
...
public class Puzzle1 {
    ...
    /**
     * <p>--- Day 5: If You Give A Seed A Fertilizer ---</p>
     ...
     * <p>The rest of the almanac contains a list of <b>maps</b> which describe how to convert numbers from a <b>source category</b> into numbers in a <b>destination category</b>. That is, the section that starts with seed-to-soil map: describes how to convert a <b>seed number</b> (the source) to a soil number (the destination). This lets the gardener and his team know which soil to use with which seeds, which water to use with which fertilizer, and so on.</p>
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        System.out.println(solve("day5/input.txt"));
    }
