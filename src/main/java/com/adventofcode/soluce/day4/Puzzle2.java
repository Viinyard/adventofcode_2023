...
import com.adventofcode.day4.grammar.Day4Lexer;
import com.adventofcode.day4.grammar.Day4Parser;
...
public class Puzzle2 {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        System.out.println(solve("day4/input.txt"));
    }
    ...
    static int solve(String fileName) throws IOException, URISyntaxException {
        ...
        return Stream.iterate(scratchcard.getFirst(), Objects::nonNull, ASD.Scratchcard::getNext).peek(ASD.Scratchcard::scratch).mapToInt(ASD.Scratchcard::getNumberOfCopies).sum();
    }
}
